...
### Proxy
  ...
  - A proxy looks and behaves like it is the current object, but underlying it has some extra functionality and features.
  - Smart pointers are the best example of this in C++: they look and behave like normal raw pointers, but underlying they are so much more than that.
...
### Command Design Pattern
  - `An object which represents a set of instructions to perform a particular action.`
  - Contains all the necessary information to act.
...
### Interpreter Design Pattern
  ...
  - Does so by turning it into separate lexical tokens(lexing) and interpreting the sequences of said tokens(parsing)
